...
class BRCookiebar {
                    ...
                    const group = `
                      <div class="br-item group-info">
                        ...
                        item.groupAlertMessage
                            ? `<span class="feedback warning" role="alert">${item.groupAlertMessage}<a href="#" class="feedback-warning-close" onclick="$(this).parent().remove();return false;">x</a></span>`
                            : ''
                    }
                          </div>
                        </div>
        ...
        cookieList.forEach((cookie, index) => {
            cookieInfo += `<div class="br-card">
                ...
                !cookie.cookieSelected && cookie.alertMessage
                    ? `<span class="feedback warning" role="alert">${this.data.cookieGroups[groupIndex].cookieList[index].alertMessage}<a href="#" class="feedback-warning-close" onclick="$(this).parent().remove();return false;">x</a></span>`
                    : ''
            }
                          </div>
                        </div>
    ...
    _insertAllSelectedAlertMessage() {
        ...
        if (this.data.allAlertMessage && this.data.allAlertMessage !== '') {
            const messageTemplate = `<span class="feedback warning" role="alert">${this.data.allAlertMessage}<a href="#" class="feedback-warning-close" onclick="$(this).parent().remove();return false;">x</a></span>`
    ...
    _insertGroupAlertMessage(indexGroup) {
        ...
        if (
            ...
            const messageTemplate = `<span class="feedback warning" role="alert">${this.data.cookieGroups[indexGroup].groupAlertMessage}<a href="#" class="feedback-warning-close" onclick="$(this).parent().remove();return false;">x</a></span>`
    ...
    _insertAlertMessage(indexGroup, indexCookie) {
        if (
            ...
            const messageTemplate = `<span class="feedback warning" role="alert">${this.data.cookieGroups[indexGroup].cookieList[indexCookie].alertMessage}<a href="#" class="feedback-warning-close" onclick="$(this).parent().remove();return false;">x</a></span>`
