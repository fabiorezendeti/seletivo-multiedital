...
const terceiros_domains = [
    ...
    '//open.spotify.com',
    '//siasg.centralit',
    '//chatbotatendimento-producao.azurewebsites.net',
...
function _delete_cookie(name) {
    ...
    document.cookie = name + '=; expires=Thu, 01 Jan 2000 00:00:01 GMT; path=/; domain=.ifc.edu.br';
    // para remover os cookie do analytics nos ambientes de producao, funciona apenas informando o domain
    document.cookie = name + '=; expires=Thu, 01 Jan 2000 00:00:01 GMT; path=/; domain=candidato.ifc.edu.br';
}
