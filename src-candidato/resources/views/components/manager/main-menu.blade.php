  ...
  <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-2 lg:py-6">
    <div id="logo-header" class="pl-4 flex items-center">
      <a class="text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="/manager">
        <img class="w-40" src="{{asset('img/logo_ifc.png')}}" alt="{{ App\Repository\ParametersRepository::getValueByName('nome_instituicao_curto') }}"> </a>
    </div>
    <!--mobile-menu-->
    ...
    <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 text-black p-4 lg:p-0"
      id="nav-content">
      <div class="list-reset lg:flex justify-end flex-1 items-center mr-10">
        <ul class="">
          ...
          <li
            ...
            <div class="">
              <x-jet-dropdown align="left" width="48">
                ...
                <x-slot name="content">
                  <x-jet-dropdown-link href="{{ route('admin.pagtesouro-settings.index') }}">
                    PagTesouro
                  </x-jet-dropdown-link>
                  <x-jet-dropdown-link href="{{ route('admin.api-settings.index') }}">
                    API Tokens
                  </x-jet-dropdown-link>
                </x-slot>
              </x-jet-dropdown>
          ...
          <li
            ...
            <a href="{{ route('admin.dashboard-admin.index') }}">
              Estatísticas
            </a>
          </li>
          @endcan
            ...
            <div class="">
              <x-jet-dropdown align="left" width="48">
                ...
                <x-slot name="content">
                  ...
                  <x-jet-dropdown-link href="{{ route('admin.special-needs.index') }}">
                    Necessidades Específicas
                  </x-jet-dropdown-link>
                  <x-jet-dropdown-link href="{{ route('admin.exam-resources.index') }}">
                    Recursos p/ Realizar Prova
                  </x-jet-dropdown-link>
                  <x-jet-dropdown-link href="{{ route('admin.document-types.index') }}">
                    Tipos de Documentos
                  </x-jet-dropdown-link>
                  @endcan
                  @can('isAcademicRegister')
                  <x-jet-dropdown-link href="{{ route('cra.notices.index') }}">
                    Editais
                  </x-jet-dropdown-link>
                  @endcan
                  @can('isAcademicRegisterOrAdmin')
                  <x-jet-dropdown-link href="{{ route('admin.process.exam-locations.index') }}">
                    Locais de Prova
                  </x-jet-dropdown-link>
                  @endcan
                </x-slot>
            ...
            <div class="">
              <x-jet-dropdown align="right" width="48">
                ...
                <x-slot name="content">
                  ...
                  @can('isAdmin')
                  <x-jet-dropdown-link href="{{ route('dev.maintenance.index') }}">
                    Modo Manutenção
                  </x-jet-dropdown-link>
                  @endcan
