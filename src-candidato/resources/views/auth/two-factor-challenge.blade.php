    ...
    <x-jet-authentication-card>
        ...
        <div x-data="{ recovery: false }">
            <div class="mb-4 text-sm text-gray-600" x-show="! recovery">
                Por favor, confirme seu acesso adicionando o código de autenticação fornecido pelo aplitivo autenticador
            </div>

            <div class="mb-4 text-sm text-gray-600" x-show="recovery">
                Por favor, confirme seu acesso adicionando um dos seus códigos de recuperação
            </div>
            ...
            <form method="POST" action="/two-factor-challenge">
                ...
                <div class="mt-4" x-show="recovery">
                    <x-jet-label value="Código de recuperação" />
