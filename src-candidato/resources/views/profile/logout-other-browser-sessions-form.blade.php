<x-jet-action-section>
    ...
    <x-slot name="description">
        Gerenciar e sair de sessões ativas em outros navegadores ou dispositivos        
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            Se necessário, você pode sair de todos os outros navegadores ou dispositivos que você está conectado. Faça isso se você percebeu que sua conta foi comprometida, ou se quer força a atualização de seu password.            
        </div>
