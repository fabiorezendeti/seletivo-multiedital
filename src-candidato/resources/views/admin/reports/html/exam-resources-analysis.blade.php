    ...
    <div class="container mx-auto" style="page-break-after: always">
        <div class="flex flex-col items-center">
            <x-report-header>
                ...
                <div class="text-2xl font-bold">Relatório Solicitações de Recursos para Prova</div>
        ...
        <table class="w-full">
            ...
            @foreach ($dados as $d)
                <tr>
                    ...
                    <td class="text-center">{{ $d->recurso }}</td>
                    <td class="text-center">{{ (json_decode($d->analise))->approved_ptBR }}</td>
