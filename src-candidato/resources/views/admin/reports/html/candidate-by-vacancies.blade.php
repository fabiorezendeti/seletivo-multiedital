        ...
        <table class="w-full">
            ...
            <tbody class="text-center uppercase">
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $offer->getTotalVacancies($selectionCriteria)}}</td>
                    <td class="text-center">{{ round($offer->getTotalHomologatedSubscriptions($selectionCriteria) / $offer->getTotalVacancies($selectionCriteria),2)  }} </td>
                </tr>
                @endforeach
            </tbody>
        </table>
