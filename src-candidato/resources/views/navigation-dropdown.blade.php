    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @can('managerArea')
                <x-jet-nav-link align="right"  href="/manager">
                    <button
                            class="flex text-sm border-2 bg-gray-200 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out"
                            title="Configurações Gerais do Sistemas">
